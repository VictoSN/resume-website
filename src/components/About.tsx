function About() {
    return (
        <div>
            ...
            <p className="font-display text-2xl font-normal leading-relaxed text-[#1a1a1a] dark:text-[#E8E4DC]">
                I'm a final-year Computer Science student at Asia Pacific University, originally from Indonesia.
            </p>
            <p className="mt-4 text-sm leading-relaxed text-[#1a1a1a]/60 dark:text-white/40 font-light">
            ...
            <div className="mt-8 grid grid-cols-3 gap-4">
                {[
                    ...
                    <div key={label} className="border border-[rgba(0,0,0,0.08)] dark:border-[rgba(255,255,255,0.06)] rounded-lg p-4">
                        <p className="font-display text-3xl font-bold text-[#1a1a1a] dark:text-[#E8E4DC]">{value}</p>
